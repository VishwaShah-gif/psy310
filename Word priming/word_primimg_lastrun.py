...
expName = 'word_primimg'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\hp\\Downloads\\PsychoPy_Tutorial\\Word priming\\word_primimg_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('C:/Users/hp/Downloads/PsychoPy_Tutorial/Word priming/test_words.xlsx'),
