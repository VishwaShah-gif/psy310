...
expName = 'emotional stroop task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\hp\\Downloads\\PsychoPy_Tutorial\\solo project\\emotional stroop task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_4 = visual.TextStim(win=win, name='text_4',
        text='You will now be asked to recall the colors associated with the words you just saw.\n\nPlease press the following keys for each color:\n\nRed     - r\nBlue    - b\nGreen   - g\nYellow  - y\nPink    - p\nOrange  - o\nBlack   - k\nViolet  - v\nWhite   - w\nBrown   - n\n\nPress any key to continue.\n',
        font='Arial',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('stroop_cons.xlsx'),
    ...
    for thisTrial_2 in trials_2:
        ...
        thisExp.addData('association.started', globalClock.getTime(format='float'))
        text_3.setText(Word)
        polygon.setFillColor(Color)
        # keep track of which components have finished
        associationComponents = [text_3, polygon, text_6]
        for thisComponent in associationComponents:
        ...
        thisExp.addData('association.stopped', globalClock.getTime(format='float'))
    ...
    for thisTrial in trials:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('StroopTask.started', globalClock.getTime(format='float'))
        text.setText(Word)
        ...
        _key_resp_allKeys = []
        # keep track of which components have finished
        StroopTaskComponents = [text, key_resp]
        for thisComponent in StroopTaskComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['r', 'b', 'g', 'y', 'p', 'o', 'k', 'v', 'w', 'n'], ignoreKeys=["escape"], waitRelease=False)
        ...
        for thisComponent in StroopTaskComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('StroopTask.stopped', globalClock.getTime(format='float'))
        # check responses
